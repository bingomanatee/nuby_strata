...
Router.prototype.call = function call(env, callback) {
    ...
    console.log('trying routes for method %s', method);
...
function tryRoutes(routes, env, callback, defaultApp) {
    return function tryRoute(n) {
        ...
        var keys = route[1];
        var app = route[2];
      //  console.log('matching %s to path %s', pattern, env.pathInfo);
        var match = pattern.exec(env.pathInfo);

        if (match) {
            console.log('!!! match!!! %s', pattern.toString());
            ...
            app(env, function (status, headers, body) {
                ...
                if (headers["X-Cascade"] == "pass") {
                 ...
                 //   console.log('routing to %s', callback.toString());
