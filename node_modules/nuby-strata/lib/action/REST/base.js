...
Base_Action.prototype._on_get = function (err, item, env, on_data_callback) {
    //@TODO: check error
    on_data_callback(err, item);
}
...
Base_Action.prototype._data_to_env = function (env, data) {
    var out = {};
    out[this.controller.name] = data;
    env._data = out;
}

Base_Action.prototype.do_render = function (env, callback) {
    ...
    if (this.ticket) {
        this.ticket(env._render_params.data, _on_ticket);
