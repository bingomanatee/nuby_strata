...
module.exports = function (err, content, env, on_render) {
    ...
    if (err) {
        ...
        action.layout(env, content, on_render);
        ...
        action.controller.layout(env, content, on_render, action);
        ...
        if (action.controller.hasOwnProperty('_layout_template')) {
            ...
            template_loader(action.controller.layout_template, context, function (err, template) {
                action.controller._layout_template = template;
                action.controller._layout_template.render(env, content, _on_layout_render, action);
            });
