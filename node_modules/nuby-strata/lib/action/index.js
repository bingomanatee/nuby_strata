...
Action.prototype = {
       ...
       // console.log('action::_on_data data = %s', util.inspect(data));
        ...
        if (env.route.hasOwnProperty('format')) {
           // console.log('has format');
            ...
            action._on_format(env, data, format, app_callback);
    ...
    _on_format:function (env, data, format, app_callback) {
        switch (format) {
            case 'json':
    ...
    data:function (env, app_callback) {
        this._on_data(null, {}, env, app_callback);
    },
