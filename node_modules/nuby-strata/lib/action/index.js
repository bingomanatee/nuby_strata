...
Action.prototype = {
    ...
    handle:function (config, type) {
        ...
        // console.log('ns_path: %s', ns_path);

        var nuby_strata = require(ns_path);
        //  console.log('nuby strata: %s', util.inspect(nuby_strata));
        var def_handler = nuby_strata.loader.loader('default');
        return def_handler.scaffolding['default'].handle(config, type);
    },
    ...
    render:function (params, callback) {
        ...
        return smr(this._view_path, params, callback);
    },
...
module.exports = {
    ...
    render_by_ct:function (action) {
        ...
        action.render = function (params, callback) {
            ...
            action.controller.render(params, callback);
        }
    },
